...
@interface KMPageTicker () <UIScrollViewDelegate>
...
- (void)layoutSubviews
{
    ...
    _numberOfItems = [self.dataSource numberOfItemsInPageTicker:self];
...
- (void)insertViewAtIndex:(NSInteger)index
{
    ...
    UIView *view = [self.dataSource pageTicker:self viewAtIndex:targetIndex];
    view.frame = rect;
